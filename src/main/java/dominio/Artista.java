...
public class Artista implements Serializable {
	...
	public Artista(Integer codArtista, String nome, String pais, BigDecimal cache, Date nascimento) {
		super();
	...
	public String toString() {
		return "Artista [codArtista=" + codArtista + ", nome=" + nome + ", cache=" + cache + ", nascimento="
				+ nascimento + "]";
	}
